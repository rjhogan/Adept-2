...
\date{Document version 2.0.2 (October 2017) applicable to \Adept\ version
  2.0.2 \thanks{This document is copyright \copyright\ Robin J. Hogan
...
also compiles with the Clang and Intel compilers. The code is built
with the help of a \code{configure} shell script generated by GNU
autotools.  If you are on a non-Unix system (e.g.\ Windows) and cannot
use shell scripts, see section \ref{sec:non-unix}.
