...
\lstset{language=C++,
  ...
  emph={adouble,xdouble,Stack,adept,Array,FixedArray,Vector,aVector,Matrix,aMatrix,Array3D,aArray3D,intVector,boolVector,floatVector,SpecialMatrix,SquareMatrix,aSquareMatrix,SymmMatrix,aSymmMatrix,UpperMatrix,LowerMatrix,IndexVector,adept_arrays},
...
Intel hardware and the NEON instruction set on ARM. If a library you
